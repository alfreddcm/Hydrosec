                        ...
                        <span class="fs-4">
                            <div class="dropdown ps-1">
                                <a href="#"
                                    ...
                                    <strong>
                                        @php
                                            ...
                                            if (Auth::check()) {
                                                $decryptedName = Crypt::decryptString(Auth::
                                                user()->name);
                                            }
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark text-small shadow"
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('adminprofile') }}">Manage
                                            Account</a></li>
                                    <li>
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li>
                            <a href="{{ route('UserAccounts') }}"
                                class="nav-link {{ request()->is('Admin/UserAccounts') ? 'active' : 'text-white' }}">
                                <svg class="bi me-2" width="16" height="16">
