...
<link href="{{ asset('css/owner/managetower.css') }}"
      rel="stylesheet">
...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                                        ...
                                        <div class="card shadow-sm mb-4 border-0">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <h5 class="card-title text-uppercase text-primary no-line-spacing">
                                                            <b>{{ $count = $count + 1 }} &nbsp;| &nbsp;
                                                                {{ Crypt::decryptString($data->name) }}</b>
                                                        </h5>
                ...
                <div class="addtowerb">
                    <a href="#"
                       class="btn btn-success mt-1 addtowerbutton"
    ...
    <div class="modal fade"
         id="addTowerModal"
         tabindex="-1"
         aria-labelledby="addTowerModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="addTowerModalLabel">Add Tower</h5>
                    <button type="button"
                            class="btn-close"
                ...
                <div class="modal-body">
                    <form action="{{ route('posttower') }}"
                          method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="towercode"
                                   class="form-label">Tower Name</label>
                            <input type="text"
                                   class="form-control"
                                   id="name"
                                   name="name"
                        ...
                        <div class="mb-3">
                            <label for="towercode"
                                   class="form-label">Tower Code</label>
                            <input type="text"
                                   class="form-control"
                                   id="towercode"
                                   name="towercode"
