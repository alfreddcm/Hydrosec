...
@section('content')
<link rel="stylesheet" href="{{ asset('assets/css/main.css') }}" class="rel">
    ...
    <body>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p class="fs-8 my-4 pb-2">Register to use HYDROSEC, a multi-level Security Web Smart monitoring
                            system</p>
                        <div>
                            <form id="form" class="d-flex align-items-center position-relative" method="POST"
                                action="{{ route('checkEmail') }}">
                                @csrf
                                <input type="email" name="email" placeholder="Enter email to have access"
                                    class="form-control bg-white border-1 rounded-4 shadow-none px-4 py-3 w-100" required>
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="image-container">
                            ...
                            <div class="col-lg-4 order-lg-last hero-img aos-init aos-animate" data-aos="zoom-out" data-aos-delay="100">
                                <img src="images/lettu.png" class="img-fluid animated" alt="">
                              </div>
        ...
        <script>
            ...
            */
            ...
            html:
            '
        <b>Be patient.</b><br />Checking Email.',
